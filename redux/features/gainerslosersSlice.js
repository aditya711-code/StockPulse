...
export const fetchTopGainersLosers = createAsyncThunk(
  "topGainersLosers/fetchData",
  async (_, { getState }) => {
    const url = API_URLS.getTopGainersAndLosers();
...
export const { updateLoading, updatePricePercentage, updateType } =
  topGainersLosersSlice.actions;
